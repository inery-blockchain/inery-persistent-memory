...
typedef IneryCompositeKVCache<dbk::DEX_BLOCK_ORDERS,  tuple<CFixedUInt32, uint8_t, uint256>, dex::CDEXOrderDetail>     DEXBlockOrdersCache;
...
public:
    ...
    bool GetDexOperatorByOwner(const IneryRegID &regid, DexID &id, DexOperatorDetail& detail);
    bool HaveDexOperator(const DexID &id);
    bool HasDexOperatorByOwner(const IneryRegID &regid);
...
/*  ----------------   -----------------------------  ---------------------------  ------------------   ------------------------ */
    ...
    IneryCompositeKVCache< dbk::DEX_ACTIVE_ORDER,          uint256,                     dex::CDEXOrderDetail >     activeOrderCache;
    DEXBlockOrdersCache    blockOrdersCache;
    IneryCompositeKVCache< dbk::DEX_OPERATOR_DETAIL,       std::optional<IneryVarIntValue<DexID>> , DexOperatorDetail >   operator_detail_cache;
    IneryCompositeKVCache< dbk::DEX_OPERATOR_OWNER_MAP,    IneryRegIDKey,               std::optional<IneryVarIntValue<DexID>>> operator_owner_map_cache;
    InerySimpleKVCache<dbk::DEX_OPERATOR_LAST_ID, IneryVarIntValue<DexID>> operator_last_id_cache;
