...
namespace dbk {
    ...
    #define DBK_PREFIX_LIST(DEFINE) \
        ...
        DEFINE( PRODUCER_FEE,            "minf",   SYSPARAM )         \
        ...
        DEFINE( KEYID_ACCOUNT,        "idac",   ACCOUNT )       /* idac{$KeyID} --> $IneryAccount */ \
        /**** contract db                                                                      */ \
        ...
        DEFINE( CONTRACT_ACCOUNT,     "cacc",   CONTRACT )      /* cacc{$ContractRegId}{$AcIneryUserId} --> appUserAccount */ \
        DEFINE( CONTRACT_TRACES,      "ctrs",   CONTRACT )      /* [prefix]{$txid} --> contract_traces */ \
        /**** delegate db                                                                      */ \
        DEFINE( VOTE,                 "vote",   DELEGATE )      /* "vote{(uint64t)MAX - $votedINRs}{$RegId} --> 1 */ \
        ...
        /**** cdp db                                                                     */ \
        DEFINE( CDP,                  "cid",    CDP )           /* cid{$cdpid} --> IneryUserCDP */ \
        DEFINE( CDP_INR,            "cbcn",   CDP )           /* [prefix]{$INR_symbol} --> $cdpINRDetail */ \
